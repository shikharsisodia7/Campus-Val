...
- Course catalog data: ~2,308 courses scraped from SCU's 2025-2026 undergraduate bulletin (`artifacts/api-server/src/data/courses-data.json`). All ~58 undergraduate departments. Per-quarter sections, instructors, and seat counts intentionally NOT included — that data lives in Workday Student / Camino and requires SCU SSO login. Honest disclosure banners shown on dashboard and courses pages.
