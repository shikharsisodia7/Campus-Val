...
const FOUR_YEAR_CSE: GraduationPathEntry = {
  ...
  risks: [
    "If you fail/repeat COEN 11 or 12 you'll need a summer or 5th year.",
  ...
  quarters: [
    ...
    { year: 1, term: "winter", label: "Y1 Winter", courses: ["MATH 12", "COEN 10", "ENGL 1B", "TESP 2"], plannedUnits: 16 },
    { year: 1, term: "spring", label: "Y1 Spring", courses: ["MATH 13", "COEN 11", "PHYS 31", "HIST 11A"], plannedUnits: 17 },
    { year: 2, term: "fall", label: "Y2 Fall", courses: ["MATH 14", "COEN 12", "PHYS 32", "COMM 12"], plannedUnits: 17 },
    { year: 2, term: "winter", label: "Y2 Winter", courses: ["MATH 22", "COEN 19", "PHYS 33", "TESP 3"], plannedUnits: 17 },
    { year: 2, term: "spring", label: "Y2 Spring", courses: ["MATH 53", "COEN 20", "ECON 1"], plannedUnits: 14 },
    { year: 3, term: "fall", label: "Y3 Fall", courses: ["COEN 21", "ENGL 2"], plannedUnits: 8, notes: "Light load — internship search quarter." },
...
const THREE_YEAR_CSE: GraduationPathEntry = {
  ...
  risks: [
    ...
    "PHYS 32 + COEN 12 + MATH 22 simultaneously is 12 units of heavy STEM.",
    "No room for failure: a single C- prereq miss costs at least one summer.",
  ],
  quarters: [
    { year: 1, term: "fall", label: "Y1 Fall", courses: ["ENGR 1", "MATH 11", "COEN 10", "ENGL 1A", "TESP 1"], plannedUnits: 17 },
    { year: 1, term: "winter", label: "Y1 Winter", courses: ["MATH 12", "COEN 11", "ENGL 1B", "TESP 2", "COMM 12"], plannedUnits: 20 },
    { year: 1, term: "spring", label: "Y1 Spring", courses: ["MATH 13", "COEN 12", "PHYS 31", "HIST 11A", "PHIL 9"], plannedUnits: 21, notes: "Overload (>20) requires GPA ≥ 3.0 + dean approval." },
    { year: 2, term: "fall", label: "Y2 Fall", courses: ["MATH 14", "COEN 19", "PHYS 32", "TESP 3", "ECON 1"], plannedUnits: 22, notes: "Overload (junior standing achievable here only if AP credit is in)." },
    { year: 2, term: "winter", label: "Y2 Winter", courses: ["MATH 22", "COEN 20", "PHYS 33", "HIST 11B"], plannedUnits: 18 },
    { year: 2, term: "spring", label: "Y2 Spring", courses: ["MATH 53", "COEN 21", "ENGL 2", "PSYC 1"], plannedUnits: 16 },
