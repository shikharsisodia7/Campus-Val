...
/**
 * The Workday Academic Progress Report reference column — used identically
 * in Degree Plan, Tentative Degree Plan, and Quarter Plan (the professor
 * explicitly asked that "this window look just like the same window each
 * time"). It is the university record and NOTHING else: no plan controls,
 * no major/minor editing, no CampusVal-generated progress widgets or
 ...
 *
 * Upload/Replace lives in each page's own executive control bar, directly
 * above this column, so this panel stays focused on report content.
 */
export function WorkdayAprPanel() {
  const {
    data: reportEnvelope,
    ...
    <Card className="flex h-full flex-col overflow-hidden border-border/60 bg-card shadow-sm">
      ...
      <ScrollArea className="h-full flex-1">
        <div className="p-3 space-y-4">
          ...
          >
            <p>
              This is a university record from Workday. It is modified
              through Workday, not CampusVal — use it as your comparison
              point against your CampusVal plans.
            </p>
